...
_TEXT_TOOLS = {"polish", "tldr", "eli5", "excel", "eat", "reply"}
...
def _normalize_tool_name(name: str) -> str:
    """把命令别名规范成内部 tool 名。处理图+文字生图/改图、图生视频的多别名。"""
...
_PENDING_TEXT_CONSUMABLE_TOOLS = {"img", "meme", "eat", "reply", "eli5"}
